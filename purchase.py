...
if driver.find_elements_by_class_name("text-center")[0].text=='Thank you for your order!' and payable_amount_before_checkout==payable_amount_after_checkout and payable_amount_after_checkout==paid_amount:
